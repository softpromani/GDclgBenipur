  ...
  <div class="row mb-2">
    ...
    <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><a href="#">SSR</a></li>
      </ol>
    </div>
  </div>
</div>
...
<div class="card">
    <form method="post" action="{{route('admin.savessr')}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group m-3">
            <div class="row">
                <div class="col-md-6">
                    <label>Upload SSR<span class="clcl"> *</span></label>
                    <input type="file"  name="file"  class="form-control"  required />
                </div>
            </div>
            <div class="col-sm-2 mt-4">
                <button type="submit" class="btn btn-primary">Add SSR </button>
            </div>
        </div>
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Details of SSR</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
          ...
          @foreach ($files as $file )
            <tr>
                <td>{{$sn}}</td>
                <td><a href="{{asset('/upload/ssr/').'/'.$file->filename}}" target="_blank">View</a></td>
                <td>{{$file->title}}</td>
