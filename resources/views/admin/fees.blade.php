...
<div class="container-fluid">
  <div class="row mb-2">
    <div class="col-sm-6">
      <h1>Manage Fees Structure</h1>
    </div>
    <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="#">Home</a></li>
        <li class="breadcrumb-item"><a href="#">Fees Structure</a></li>
      </ol>
    </div>
  </div>
</div>
...
<div class="card">
    <form method="post" action="{{route('admin.savefeestructure')}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group m-3">
            <div class="row">
                <div class="col-md-6">
                    <label>Upload Fees Structure<span class="clcl"> *</span></label>
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Details of Fees Structure</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
        <table id="example1" class="table table-bordered table-striped">
          ...
          @foreach ($files as $file )
            <tr>
                <td>{{$sn}}</td>
                <td><a href="{{asset('/upload/fees/').'/'.$file->filename}}" target="_blank">View</a></td>
                <td>{{$file->title}}</td>
...
<script>
    var newurl="{{route('admin.delfeestructure')}}";
    var swname=" Fees";
</script>
