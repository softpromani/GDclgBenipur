...
<div class="container-fluid">
  <div class="row mb-2">
    <div class="col-sm-6">
      <h1>Add Non-Teacher</h1>
    </div>
    <div class="col-sm-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="#">Home</a></li>
        <li class="breadcrumb-item"><a href="#">Add Non-Teacher</a></li>
      </ol>
    </div>
  </div>
</div>
...
<div class="card">
    <form method="post" action="{{route('admin.savenonteacher')}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group m-3">
            <div class="col-sm-2 mt-4">
                <button type="submit" class="btn btn-primary">Add Non-Teacher</button>
            </div>
        </div>
