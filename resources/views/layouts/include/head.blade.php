<meta charset="utf-8">
  ...
  <title>Admin | Degree College</title>

  <!-- Google Font: Source Sans Pro -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
   <!-- Toastr -->
   <link rel="stylesheet" href="{{asset('adminlayout/plugins/toastr/toastr.min.css')}}">
  ...
  <link rel="stylesheet" href="{{asset('adminlayout/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
  <!-- iCheck -->
